...
export interface ChapterVersion { id: string; projectId: string; chapterId: string; content: string; chapterRevision: number; createdAt: string; actor: string; accepted: boolean; summary: string; restoredFrom?: string; commitKey?: string; requestIds?: string[]; }
