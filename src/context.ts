...
export function buildContext(domain:Domain,projectId:string,options:{chapterId?:string;goal?:string;maxChars?:number;entityIds?:string[];purpose?:'generation'|'state-refresh'}={}):ContextPack {
